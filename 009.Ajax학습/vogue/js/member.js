            ...
            // **** 4. 아이디일때 검사하기 ***********************
                ...
                */
                ...
                if (!res) { // ! (NOT 연산자)로 결과 반대로!
                    ...
                    /* 
                        [ AJAX로 중복아이디 검사하기! ]
                          : 원래 post방식과 get방식 2가지 있다. 이 2가지 비동기 처리 방식이 각각 있다.(1번과 2번)
                            이거 말고도 직접 선택할 수 있는 메서드가 있다. (그것이 3번이다.) 
                            3번 선택내용을 보면 "전송방식"이 있는데 거기서 타입이 post인지 get인지 선택할 수 있다.
                            그리고, 3번이 좋은게 세밀히 선택할 수 있다는 것이다.
                          ...
                          3) 위 2가지 유형 중 선택처리 메서드 (실패처리는 생략가능하나, 통상적으로 7개 다 쓴다.)
                    ...
                    */
                    ...
                    $.ajax({ // 객체형식으로 보냄 {} // ▶ E:\MyGit\FED\009.Ajax학습\vogue\process >> "chkID.php"
                        ...
                        //               -> 여기서는 pass를 쓰기 위함(통과여부) 변수를 쓸 수 있다.
                        //                  통과여부 false >> pass = false; 썼기에 아래 이게 먹는 것.
                        async: false,
