...
$(function () { //////// jQB (제이쿼리 코드블록) //////////////////
    ...
    $(".gnb a, .indic a").click(function (e) { /* 이벤트 메서드 사용 필요에 따라서 두개 선택가능 .gnb a, .indic a (구조도 같고, 목적도 같아서 가능) */
        ...
        */
               ...
               $(".gnb li").eq(pno).addClass("on") /* $(this).parent() ->> 2개다 움직여야해서 바꿈 직접 지정(".gnb li")  */
